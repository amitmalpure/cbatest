...
import com.cba.utils.CBADataProvider;
import com.cba.utils.StringUtils;
import com.cba.utils.WebDriverUtil;
import com.cba.web.pageactions.HomePageActions;
import com.cba.web.pageactions.RepaymentCalculatorPageActions;
...
public class HomeLoanTest 
{
    ...
    @Test (dataProvider = "data-provider", dataProviderClass = CBADataProvider.class, priority=1)
    ...
    @Test (dataProvider = "data-provider", dataProviderClass = CBADataProvider.class, priority=2)
